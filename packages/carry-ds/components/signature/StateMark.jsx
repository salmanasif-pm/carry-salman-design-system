...
export function StateMark({certainty, gated, gate, owner, clears, review, release, state, label, size=14, showLabel=true, style}) {
  ...
  return <span style={outer} data-carry-certainty={cc} data-carry-gated={isGated?'true':undefined} data-carry-release={release} title={text}>
